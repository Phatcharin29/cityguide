    ...
    <div class="cg-single-content">
        ...
        <div class="cg-card-featured">
          ...
          <div class="cg-card-text">
            <div class="cg-card-tags">
              <a href="#"
                  class="tag">Religious</a>
              <a href="#"
                  class="tag">Relaxation</a>
              <a href="#"
                  class="tag">Day Trip</a>
            </div>
            <div class="cg-card-content">
              <a href="#" class="headline line-clamp-2">
      ...
      <div class="cg-single-content-sidebar">
        <div class="sidebar">
          ...
          <div class="cg-card-location">
            <img class="cg-card-image"
                  src="<?php echo get_theme_file_uri()?>/assets/images/icon.png"
                  alt="icon">
            <div class="cg-card-text">
              <p class="cg-card-title">
                Icon siam riverfront luxury mall
              </p>
              <p class="cg-card-meta">Chaophraya</p>
            </div>
          </div>
